...
export declare function renderFreeBalanceInEth(freeBalance: NodeTypes.GetFreeBalanceStateResult): void;
export declare function fetchMultisig(baseURL: string, token: string): Promise<string>;
export declare function deposit(node: Node, amount: string, multisigAddress: string, skip?: boolean): Promise<void>;
