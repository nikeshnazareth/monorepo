...
import { InstructionExecutor, StateChannel, Opcode } from "@counterfactual/machine/src";

const randomHDNode = () => utils.HDNode.fromMnemonic(utils.HDNode.entropyToMnemonic(utils.randomBytes(20)));
...
export class MiniNode {
  ...
  constructor(
    ...
    this.ie = new InstructionExecutor(
